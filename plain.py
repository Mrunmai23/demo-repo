...
image = tk.PhotoImage(file="D:\GENEARL\XBEE Confg\demo-repo\inspace.png")
...
# load image to be "edited"
image1= tk.PhotoImage(file="D:\GENEARL\XBEE Confg\demo-repo\inspace.png")
original_image1 = image1.subsample(3,3)  

frame10=tk.Frame(window,width=400,height=200,bg="black")
frame10.place(x=1150,y=120)
# Inspace image
Label(frame4, image=image1).grid(row=0,column=0, padx=5, pady=5)

frame5=tk.Frame(window,width=500,height=550,bg="gray18")
